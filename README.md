...
- **Share any view**: every page has its own link.

## The data

We track the 10,000 most starred repositories on GitHub, listed at
four points in time: the start of 2015, 2020, 2025, and today (September 2026)

A name is counted once per repository, so a number answers "how many of these
projects have a `README.md`?". The site carries the names more than 50
repositories have today: about 4,900 files, 2,500 directories, and 380
extensions.
